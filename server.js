...
// getting the random word and giving it to the player-----------------------------------------------------
  ...
  const getRandomWord=()=>{
    const words = ["Kangaroo", "Wand", "Surfboard", "UFO", "Pirate",
                   ...
                   "Spaceship", "Maze", "Medusa", "Atlantis", "Agent",
                   "Werewolf", "Vampire", "Factory", "Camouflage", "Superhero",
                   "Ruins", "Haunted", "Genie", "Steampunk", "Floating",
                   "Treasure", "Alien", "Underwater", "Astronaut", "Illusion","Bicycle", 
                   ...
                   "Reflection", "Dream", "Escape", "Giant", "Myth",
                   "Fairy", "Future", "Samurai", "Shadow", "Mystery",
                   "Carnival", "Shooting", "Hidden", "Puzzle", "Surprise",
                   "Cube", "Apocalypse", "Magic", "Portal", "Scientist",
                   "Invasion", "Laboratory", "Samurai", "Dimension", "Castle",
                   "Treasure", "Battle", "Universe", "Civilization", "Galaxy"];
